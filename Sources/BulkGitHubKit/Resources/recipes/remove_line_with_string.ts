const meta: ScriptMeta = {
  ...
  params: {
    ...
    prTitle: "Remove retired deploy key reference",
    prBody: "Deletes the line referencing the retired deploy key. Generated by BulkGitHub; review the diff before merging.",
  },
};
...
async function planRepo(repoName: string, defaultBranch: string, paths: string[]): Promise<void> {
  const { needle, branch, prTitle, prBody } = job.params;
